...
export type MatchingOptions = {
     ...
     */
    goodMatchesFactor: (number | Function) | null;
    /**
     * [false] Whether to return the resulting visalization
...
export type SimilarityOptions = {
    ...
    visualize: boolean | null;
    /**
     * [TM_CCOEFF_NORMED] The name of the template matching method.
...
/**
 * '|'TM_CCORR_NORMED'|'TM_SQDIFF'|'TMSQDIFF_NORMED'} OccurrenceResultMethod
 */
export type TM_CCORR = 'TM_CCOEFF' | 'TM_CCOEFF_NORMED|';
 ...
 */
export function getImagesMatches(img1Data: Buffer, img2Data: Buffer, options?: MatchingOptions | null): MatchingResult;
/**
 ...
 */
export function getImagesSimilarity(img1Data: Buffer, img2Data: Buffer, options?: SimilarityOptions | null): SimilarityResult;
/**
 ...
 */
export function getImageOccurrence(fullImgData: Buffer, partialImgData: Buffer, options?: OccurrenceOptions | null | undefined): OccurrenceResult;
/**
