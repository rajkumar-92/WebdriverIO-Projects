...
import { ViewSection as ViewSectionLocators, TreeItem as TreeItemLocators, CustomTreeItem as CustomTreeItemLocators, DefaultTreeItem as DefaultTreeItemLocators, ExtensionsViewItem as ExtensionsViewItemLocators } from '../../locators/1.73.0';
/**
...
export declare class ViewItemAction extends BasePage<typeof ViewSectionLocators> {
    ...
    private label;
    constructor(locators: VSCodeLocatorMap, elem: ChainablePromiseElement<WebdriverIO.Element>, label: string, viewItem: TreeItem);
    /**
